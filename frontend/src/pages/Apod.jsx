        ...
        <Card sx={{ boxShadow: 3, borderRadius: 2 }}>
          ...
          <CardContent>
            ...
            <Box mt={4}>
              ...
              >
                The mood, style, and star colors below are generated by OpenAI based on the selected APOD image. 
                Watch how the starfield background changes its colors to match each new picture when you select a different date!
              </Typography>
            </Box>
          </CardContent>
        </Card>
